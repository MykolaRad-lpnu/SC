    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StorageKeeperId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StorageId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StorageKeepers", x => x.StorageKeeperId);
                    table.ForeignKey(
                        name: "FK_StorageKeepers_Storages_StorageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorageKeepers_Phone",
                table: "StorageKeepers",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StorageKeepers_StorageId",
                table: "StorageKeepers",
                column: "StorageId");
